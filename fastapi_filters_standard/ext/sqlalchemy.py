...
DEFAULT_FILTERS: Mapping[AbstractFilterOperator, Callable[[Any, Any], Any]] = {
    ...
    FilterOperator.ilike: lambda a, b: a.ilike(f"%{b}%"),
    FilterOperator.not_ilike: lambda a, b: ~a.ilike(f"%{b}%"),
    FilterOperator.starts_with: lambda a, b: a.startswith(b),
    FilterOperator.not_starts_with: lambda a, b: ~a.startswith(b),
    FilterOperator.istarts_with: lambda a, b: a.ilike(f"{b}%"),
    FilterOperator.not_istarts_with: lambda a, b: ~a.ilike(f"{b}%"),
    FilterOperator.ends_with: lambda a, b: a.endswith(b),
    FilterOperator.not_ends_with: lambda a, b: ~a.endswith(b),
    FilterOperator.iends_with: lambda a, b: a.ilike(f"%{b}"),
    FilterOperator.not_iends_with: lambda a, b: ~a.ilike(f"%{b}"),
